...
GROUP BY o.id, u.first_name, u.last_name, u.email, s.name;
...
-- Enable row level security on sensitive tables (commented out for testing)
-- ALTER TABLE users ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE user_sessions ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE user_addresses ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE notifications ENABLE ROW LEVEL SECURITY;

-- Create policies for user data access (commented out for testing)
-- These can be enabled later for production security
...
-- CREATE POLICY user_own_addresses ON user_addresses
--     FOR ALL TO app_user
--     USING (user_id = current_setting('app.current_user_id')::UUID);
...
-- Security policies: Enabled for sensitive tables